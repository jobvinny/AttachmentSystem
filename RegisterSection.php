        ...
        <div class="container-fluid toptechdark">
            <div class="row">
                <div class="col-md-12 well" id="well2">
                    <h3 class="text-center" id="top"><span class="glyphicon glyphicon-dashboard"></span>&nbsp;<b><i>S</i></b>A<b><i>S</i></b> <b><i>A</i></b>dmin <b><i>D</i></b>ashBoard</h3>
                </div>
                <div class="col-md-12">
                    <nav class="navbar navbar">
                        <div class="container">
                            <div class="navbar-header">
                                <a class="navbar-brand" href="AdminSection.php"><span class="glyphicon glyphicon-home"></span>&nbsp;Admin Operations</a>
                            </div>
                ...
                <div class="col-md-12">
                    <form role="form" class="horizontal-form regform" method="post" action="">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    <input type="text" class="form-control lwrite" autocomplete="off" placeholder="Student Name" name="studname" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control lwrite" autocomplete="off" placeholder="Mobile Number" name="monumber" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control lwrite" autocomplete="off" placeholder="National ID Number" name="natid" required>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                                    <input type="email" class="form-control lwrite text-lowercase" autocomplete="off" placeholder="Student Email" name="semail" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control lwrite" autocomplete="off" placeholder="Address" name="saddress" required>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    <input type="text" class="form-control lwrite" autocomplete="off" placeholder="School Reg_Number" name="reg_no" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control lwrite" autocomplete="off" placeholder="Course Of Study" name="course" required>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control lwrite" name="datefrom" placeholder="Date Of Start yy-mm-dd" required>
                                    <br />
                                    <label for="text">To</label>
                                    <input type="date" class="form-control lwrite" name="dateto" placeholder="Finishing Date yy-mm-dd" required>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="form-group">
                                    <input type="text" class="form-control lwrite" autocomplete="off" placeholder="Located/Section Place" name="place" required>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <input type="submit" class="form-control btn btn-md btn-dark btoptech2" name="register" value="REGISTER">
                                </div>
                            </div>
                        </div>
                    </form>
