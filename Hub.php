        ...
        <div class="container-fluid toptechdark">
            <div class="row">
                <div class="col-md-12 well" id="well2">
                    <h3 class="text-center"><span class="glyphicon glyphicon-dashboard"></span>&nbsp;<b><i>S</i></b>A<b><i>S</i></b> <b><i>S</i></b>tudent <b><i>D</i></b>ashBoard</h3>
                </div>
                <div class="col-md-12">
                    <nav class="navbar navbar">
                        <div class="container">
                            <div class="navbar-header">
                                <a class="navbar-brand" href="StudentSection.php"><span class="glyphicon glyphicon-home"></span>&nbsp;Student Operations</a>
                            </div>
            ...
            <a href="#lprint"><button class="btn btn-dark btoptech4 btn-md pull-right">Print</button></a>
            <div class="row">
                <div class="col-md-12">
                    <?php
                ...
                <button onclick="mydetails()" id="lprint" class="btn btn-lg btn-dark btoptech4 pull-right" title="Double Click To Print">
