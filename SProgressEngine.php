    ...
    <div class="row">
        <div class="col-md-12 well" id="well2">
            <h3 class="text-center"><span class="glyphicon glyphicon-dashboard"></span>&nbsp;<b><i>S</i></b>A<b><i>S</i></b>
                <b><i>S</i></b>upervisor <b><i>D</i></b>ashBoard</h3>
        </div>
        <div class="col-md-12">
            <nav class="navbar navbar">
                <div class="container">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="SupervisorSection.php"><span
                                    class="glyphicon glyphicon-home"></span>&nbsp;Supervisor Operations</a>
                    </div>
