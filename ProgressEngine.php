        ...
        <div class="container-fluid toptechdark">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    <div class="col-md-8 input-group">
                        ...
                        <input type="text" name="search_progress" id="search_progress"  class="form-control input-lg lwrite" placeholder="Search Student Progress By National_ID Number"/>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <button onclick="adminprintprogress1()" id="lprint" class="btn btn-lg btn-dark btoptech4 pull-right" title="Double Click To Print">
