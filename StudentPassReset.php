                        ...
                        <form role="form" class="horizontal-form" method="post" action="">
                          <div class="form-group input-group">
                            ...
                            <div class="form-group input-group">
                                ...
                                <input type="text" class="form-control lwrite" autocomplete="off" placeholder="Enter School Reg_No" name="reg_no" required>
                            </div>
                            <div class="form-group input-group">
                            ...
                            <div class="form-group">
                                <input type="submit" class="form-control btn btn-md btn-dark btoptech2" name="studentreset" value="RESET">
                            </div>
                            <div class="form-group">
